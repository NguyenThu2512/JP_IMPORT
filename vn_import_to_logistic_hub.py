...
while True:
    ...
    cond1 = (~(vn_import_df['tracking_id'] == "")
             & ~(vn_import_df['product_id'] == "")
             & ~(vn_import_df['package_id'] == "")
             & ~(vn_import_df['vn_date_import'] == "")
             & ~(vn_import_df['vn_storage_import'] == "")
             & ~(vn_import_df['weight_rounded'] == "")
             & ~(vn_import_df['vn_import_confirmed'] == "FALSE"))
