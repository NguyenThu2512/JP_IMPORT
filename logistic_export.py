...
while True:
    try:
        ...
        true_logistic_data=jp_export_df[['package_id','product_id','jp_date_export']].copy().reset_index()
        true_logistic_data['index']=true_logistic_data['index']+2
        ...
        if(true_logistic_data.shape[0]==0):
            ...
            logistic_hub_df=logistic_hub_df.loc[(product_id_export.isin(logistic_hub_df['product_id']))].reset_index()
